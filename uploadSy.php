...
if (isset($_POST["submit"])) {
  ...
  if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
      echo "The file ". basename( $_FILES["fileToUpload"]["name"]). " has been uploaded to a newly create Google Drive folder and Google Calendar Events have been created.";
      echo shell_exec("python syllabusUpload.py");
      echo shell_exec("python googlecalendar.py");
